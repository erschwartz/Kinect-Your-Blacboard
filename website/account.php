      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="account.php"> <img src="trash.png" onmouseover="this.src='trash2.png'"onmouseout="this.src='trash.png'" style="width:50px;height:50px;border:0;">  </a></li>
